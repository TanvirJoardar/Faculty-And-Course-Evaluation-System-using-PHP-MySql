...
if ($F_NameErr == "") {
    ...
    if (isset($_POST['submit'])) {
        ...
        $user_id = $_GET['id'];
        $sql = "UPDATE faculty SET f_name = '$F_Name', department_d_id = '$D_id' WHERE f_id='$user_id'";

        if (mysqli_query($connection, $sql)) {
            $_SESSION['message'] = 'Update Faculty info Successfully';
        } else {
            $_SESSION['message'] = 'Update Faculty info is not Successfull';
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    if (isset($_GET['id'])) {
                        $user_id = $_GET['id'];
                        $sql = "select faculty.f_name,department.d_name
                            from 
                            faculty,department
                            where 
                            faculty.department_d_id=department.d_id and faculty.f_id='$user_id'";
                        $result = mysqli_query($connection, $sql);
                    ...
                    ?>
                                ...
                                <form action="editFaculty.php?id=<?= $user_id; ?>" method="post">
                                    <div class="row">

                                        <div class="row">
                                            <div class="col-md-12 mb-3">
                                                <label for="">Faculty Name</label>
                                                <input type="text" name="f_name" value="<?= $row['f_name']; ?>" class="form-control" id="">
                                                <?php if ($F_NameErr != "") {
                                            ...
                                            <div class="col-md-12 mb-3">
                                                <input type="submit" name="submit" value="Update Faculty " class="btn btn-success" id="">
